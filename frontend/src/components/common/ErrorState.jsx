...
export default function ErrorState({
  ...
  return (
    <div className="w-full p-8 rounded-2xl border border-red-200 bg-red-50/40 flex flex-col items-center text-center">
      <div className="w-11 h-11 rounded-full bg-red-100 flex items-center justify-center text-red-700 mb-4">
